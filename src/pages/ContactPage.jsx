      ...
      <section className="py-16 md:py-20">
        <Container>
          <div className="grid gap-6 lg:grid-cols-12">
            <a
              href={contactPage.messageCta.href}
              target="_blank"
            ...
            >
              ...
              <div className="relative">
                ...
                <h2 className="mt-6 text-2xl font-bold">
                  {contactPage.messageCta.title}
                </h2>
                <p className="mt-3 max-w-sm text-sm leading-7 text-white/85">
                  WhatsApp üzerinden hızlıca mesaj gönderin, ekibimiz size
                  yardımcı olsun.
                </p>
            ...
            <div className="grid gap-6 sm:grid-cols-2 lg:col-span-7">
              <ContactCard icon={Phone} title={contactPage.phones.title}>
                {contactPage.phones.items.map((phone) => (
                  <a
                    key={phone.label}
                    href={phone.href}
              ...
              <ContactCard icon={Mail} title={contactPage.email.title}>
                <a
      ...
      <section className="bg-surface-muted pb-20 pt-4 md:pb-24">
        <Container>
          <div className="mb-6 flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
            ...
            <Button
              href="https://maps.google.com/?q=Nesibe+Aydın+Eğitim+Kurumları+Gölbaşı+Ankara"
              variant="outline"
              size="sm"
            >
              Google Maps&apos;te Aç
          ...
          <div className="overflow-hidden rounded-4xl border border-slate-200 bg-white shadow-lg shadow-primary-100/30">
            <iframe
              title="Hurra Lingo Ankara Gölbaşı konumu"
